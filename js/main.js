...
function locApi(locationIP) {
    ...
    loc.open('GET', `https://apiip.net/api/check?ip=${locationIP}&accessKey=6860db4e-ab53-4930-9695-2b684629c567`)
    loc.send()
...
function reqFirstOpenWeather() {
    ...
    req2.open('GET', `https://api.weatherapi.com/v1/forecast.json?key=4fe14684ed8f4d4faee195745240612&q=${locArr.countryName}&days=3`)
    req2.send()
...
inputSearch.addEventListener('keyup', function () {
    ...
    req.open('GET', `https://api.weatherapi.com/v1/forecast.json?key=4fe14684ed8f4d4faee195745240612&q=${inputSearchValue}&days=3`)
    req.send()
...
function displayCard1() {
    ...
    document.querySelector('.card1').innerHTML = cartona1
}
function displayCard2() {
    ...
    document.querySelector('.card2').innerHTML = cartona2
}
function displayCard3() {
    ...
    document.querySelector('.card3').innerHTML = cartona3
}
